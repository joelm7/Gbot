...
#define FIREBASE_HOST "gbot-431d9.firebaseio.com"                   // Firebase Project URL
#define FIREBASE_AUTH "J2KwVbpwhc43c70gyNa4gKdRZirmIX45mCK3B5gw"    //Firebase Database authentication key
#define WIFI_SSID "AndroidAP"                                       // WiFi SSID for NodeMCU to connect
#define WIFI_PASSWORD "mnmnmnmn"                                    //Password of wifi network 
